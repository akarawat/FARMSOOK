...
void SendTextMessage()
{
  ...
  delay(100);
  mySerial.println("AT + CMGS = \"+66959530130\"");//send sms message, be careful need to add a country code before the cellphone number
  delay(100);
...
void SubmitHttpRequest()
{
  ...
  mySerial.println("AT+HTTPPARA=\"URL\",\"gps.scsthai.com/?m=0959530130,100.1234,144.2345,10.56,300\"");// setting the httppara, the second parameter is the website you want to access
  delay(1000);
